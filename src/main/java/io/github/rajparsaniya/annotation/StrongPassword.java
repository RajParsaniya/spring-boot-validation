...
import io.github.rajparsaniya.validator.StrongPasswordValidator;
...
/**
 * Annotation to validate that a string meets strong password requirements.
 *
...
public @interface StrongPassword {
     ...
     * @since 3.0.0
     */
    String message() default "must contain upper, lower, digit, and special character";
